...
>
  <head>
    ...
    <link rel="stylesheet" href="{{url('backends/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{url('backends/css/demo.css')}}" />
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{url('backends/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}" />
    <link rel="stylesheet" href="{{url('backends/vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <script src="{{url('backends/vendor/libs/jquery/jquery.js')}}"></script>
    <script src="{{url('backends/vendor/libs/popper/popper.js')}}"></script>
